 ...
 function GetDirectorPerformance(device, period, start, valuetype, callback) {
        ...
        async.waterfall([
            function(callback){ 
                ...
                param['start'] = start;
                param['type'] = valuetype;
                param['filter_name'] = '(name=\'QueueDepthCountRange0\'|name=\'QueueDepthCountRange1\'|name=\'QueueDepthCountRange2\'|name=\'QueueDepthCountRange3\'|name=\'QueueDepthCountRange4\'|name=\'QueueDepthCountRange5\'|name=\'QueueDepthCountRange6\'|name=\'QueueDepthCountRange7\'|name=\'QueueDepthCountRange8\'|name=\'QueueDepthCountRange9\'|name=\'SysCallCount\'|name=\'KBytesTransferred\'|name=\'CurrentUtilization\'|name=\'ReadRequests\'|name=\'WriteRequests\'|name=\'ReadThroughput\'|name=\'WriteThroughput\')';
                param['keys'] = ['device','part'];
