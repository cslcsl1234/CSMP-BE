...
function GetStorageGroupsPerformance(device, period, start, end, valuetype, callback) {
    ...
    async.waterfall([
        function (callback) {
            ...
            param['filter_name'] = '(name=\'HostIOLimitExceededPercent\'|name=\'ResponseTime\'|name=\'ReadRequests\'|name=\'WriteRequests\'|name=\'ReadThroughput\'|name=\'WriteThroughput\')';
            param['keys'] = ['device', 'part'];
    ...
    async.waterfall([
        ...
        function (arg1, callback) {
            ...
            topos.querySparql(queryString1, function (response) {
                ...
                async.mapSeries(deviceList, function (device, callback) {
...
function getArrayPerformanceV2(callback) {
