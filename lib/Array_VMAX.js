...
function getArrayLunPerformanceByOne(device, lun , callback) {
        ...
        var start = util.getPerfStartTime();
        var end = util.getPerfEndTime(); 
        var filterbase = 'part==\'' + lun + '\'&device==\''+device+'\'&(parttype==\'LUN\'|parttype==\'MetaMember\')';
