...
function GetSRDFLunToReplica(device, callback) {
        ...
        async.waterfall([
            ...
            function(callback){ 
                ...
                if (typeof arraysn !== 'undefined') { 
                    param['filter'] = 'device=\''+arraysn+'\'&(source=\'VMAX-Collector\'&(datagrp=\'VMAX-RDFSOURCES\'|datagrp=\'VMAX-CLONEREPLICAS\'))';
                } else {
                    param['filter'] = '(source=\'VMAX-Collector\'&(datagrp=\'VMAX-RDFSOURCES\'|datagrp=\'VMAX-CLONEREPLICAS\'))';
                } 
...
function GetDevices(device, callback) {
        ...
        function(arg1,  callback) {  
            ...
            GetAssignedInitiatorByDevices(device,function(result) {
                ...
                HOST1.GetHBAFlatRecord(hostv,function(hbaresult) {
        ...
        function(arg1,  callback) {  
            ...
            var device1;
            GetSRDFLunToReplica(device1,function(ret) {
                for ( var i in arg1 ) {
                    var item = arg1[i];
