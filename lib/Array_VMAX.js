        ...
        function(callback) {
            CallGet.CallGet(param, function(param) {
                for (var i in param.result) {
                    ...
                    //logger.info(item.device + '=' + UsedPercent.toFixed(0));
        ...
        function(param, callback) {
            ...
            MongoDBFunc.GetArrayInfo(function(result) {
                ...
                for (var i in param.result) {
                    ...
                    logger.info("Begin get array info : " + arraysn);
                    for (var j in result) {
                    ...
                    for (var i in result) {
                        ...
                        for (var j in initgrp_res) {
                            ...
                            if ((item.device == item_init.device) &&
                                ...
                                //logger.info(item_init.device+'\t'+item_init.initgrp);
            ...
            CallGet.CallGet(param, function(param) {
                ...
                for (var i in param.result) {
                    ...
                    for (var luni in luns[item.device]) {
                        ...
                        //logger.info(item.device +","+lunItem.device +"\t"+ item.lunname +","+ item.part);
                    ...
                    for (var j in SGList) {
                        ...
                        if (item.device == resItem.device && item.sgname == resItem.sgname) {
                            ...
                            //logger.info(item.device + ":" + item.sgname + "\t" + item.devcount);
                            isFind = true;
                            break;
                        }
                    }
                    ...
                    if (isFind == false) {
                        ...
                        result['SumOfLuns'] = 1;
                        // logger.info("AAA:"+ JSON.stringify(result));
                        SGList.push(result);
                    }
                } 
...
function GetDevices(device, callback) {
    ...
    async.waterfall([
        ...
        function(arg1, callback) {
            ...
            logger.info("Begin execute : GetAssignedVPlexByDevices ... ...");
        ...
        function(arg1, callback) {
            ...
            logger.info("Begin execute : GetAssignedInitiatorByDevices ... ...111");
            GetAssignedInitiatorByDevices(device, function(result) {
                ...
                host.GetHBAFlatRecord(hostv, function(hbaresult) {
                    logger.info("              GetHBAFlatRecord->#Result=" + hbaresult.length);
                    logger.info("              #1-For: #Result=" + arg1.length);
        ...
        function(arg1, callback) {
            ...
            logger.info("Begin execute : GetSRDFLunToReplica ... ...");
            GetSRDFLunToReplica(device, function(ret) {
                logger.info("                #Result = " + ret.length + "\t" + arg1.length);
                ...
                logger.info("End execute : GetSRDFLunToReplica ... ...");
        ...
        function(arg1, callback) {
            ...
            logger.info("Begin execute: GetCloneLunToReplica ... ...")
            GetCloneLunToReplica(device, function(ret) {
                logger.info("                #Result = " + ret.length);
            ...
            CallGet.CallGet(param, function(param) {
                for (var i in arg1) {
                    ...
                    for (var j in param.result) {
                        ...
                        if (item.portwwn == item1.portwwn) {
                            item["Throughput"] = item1.Throughput;
                            item["IORate"] = item1.IORate;
                            break;
                        }
                    }
                }
    ...
    async.waterfall([
        ...
        function(arg1, callback) {
            ...
            for (var i in oriArray) {
                ...
                logger.info(item.feport + '\t' + item.name);
                item['matrics'] = [];
...
function getArrayLunGroupPerformance(device, lunStr, start, end, interval, callback) {
    ...
    async.waterfall([
        function(callback) {
            ...
            logger.info("getArrayLunPerformanceByList=" + device + "|" + lunStr + "|");
