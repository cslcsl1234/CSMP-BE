...
function GetDevices(device, callback) {
        ...
        async.waterfall([
            ...
            param['keys'] = ['device','part'];
            param['fields'] = ['model','parttype','alias','config','poolemul','purpose','dgstype','poolname','partsn','sgname','ismasked','vmaxtype','disktype'];
            param['period'] = 3600;
            param['start'] = util.getConfStartTime('1d');
        ...
        function(arg1,  callback) {  
            ...
            console.log("Begin execute : GetAssignedInitiatorByDevices ... ...");
