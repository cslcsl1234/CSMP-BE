 ...
 function GetDirectorPerformance(device, period, start, valuetype, callback) {
        ...
        async.waterfall([
            function(callback){ 
                ...
                param['start'] = start;
                param['type'] = valuetype;
                param['filter_name'] = '(name=\'SysCallCount\'|name=\'KBytesTransferred\'|name=\'CurrentUtilization\'|name=\'ReadRequests\'|name=\'WriteRequests\'|name=\'ReadThroughput\'|name=\'WriteThroughput\')';
                param['keys'] = ['device','part'];
