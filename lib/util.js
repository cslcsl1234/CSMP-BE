...
exports.CombineQueryString = function(filter, fields, start, period,limit) {
...
exports.getConfStartTime= function() {

   var d = new Date(); 
    var a = d.getTime() - ( 86400000 * 10 ) ;   // the day of 10 days before
    var s = new Date(a);
  //var date = new Date();
