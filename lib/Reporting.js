        ...
        function( arg1 , callback ) {
            ...
            getVMAXDirectorAddress( function ( address ) {
                ...
                for ( var i in address ) {
                    ...
                    if ( item.availableAddress / item.maxAvailableAddress >= 0.8 ) {
                        item["array_name"] =  arg1[item.device].device_name;
                        item["model"] = arg1[item.device].model;
                        item["percent"] = Math.round(item.availableAddress / item.maxAvailableAddress * 100);
