                    ...
                    for ( var i in arg ) {
                        ...
                        for ( var j in param ) {
                            ...
                            if ( item.device == item1.device && item.part == item1.part ) { 
                                logger.info(item.device +','+ item1.device +','+ item.part +','+ item1.part);
...
function getSPPerformance(device, part, start, end, period, valuetype, callback) {
