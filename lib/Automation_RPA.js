...
function GetRPAInfo( cdpname ) {
    ...
    if ( cdpname.indexOf("TestCase") >= 0 ) {
        // For TEST  
        logger.info("GetRPAInfo: for test" + cdpname);
                ...
                for (var i in data.ConsistencyGroups) {
                    ...
                    for (var field in item.copys) {
                        ...
                        for (var z in clusters) {
                            //logger.info(fieldItem.clusterid + "," + clusters[z].clusterid);
    ...
    async.waterfall(
        [
            ...
            function (data, callback) {
                ...
                logger.info("--------  AddVolumeToCopy for Prod ------")
                util.sleep(5000);
                var Copy;
                ...
                AddVolumeToCopy(RPAInfo, paramater, function (result) {
                    ...
                    if (result.code != 200) {
                        ...
                        async.map(Copy.splitters, function (item, subcallback) {
                            ...
                            logger.info(`*****\AddVolumeToSplitter: ${JSON.stringify(paramater)}`);
            ...
            function (data, callback) {
                ...
                logger.info("--------  AddVolumeToCopy for Local ------")
                util.sleep(5000);
                var Copy;
                if (data.request !== undefined) {
                    if (data.request.cg !== undefined) {
            ...
            function (data, callback) {
                ...
                logger.info("--------  AddVolumeToCopy for Remote ------")
                util.sleep(5000);
                var Copy;
                if (data.request !== undefined) {
                    if (data.request.cg !== undefined) {
            ...
            function (data, callback) {
                EnableConsistencyGroup(RPAInfo, CGName, function (result) {
                    logger.info("RPA: Enable Consistency Group [" + CGName + "]");
                    logger.info(result);
                    callback(null, data)
                });
...
function CreateConsistencyGroup(rpainfo, createCGParamater, callback) {
    ...
    async.waterfall(
        [
            ...
            function (arg1, callback) {
                logger.info("--------  AddJournalVolumeToCopy for Prod -------")
                util.sleep(5000);
                var paramater = {
                    "clustername": clustername,
                    "CGName": CGName,
                ...
                AddJournalVolumeToCopy(rpainfo, paramater, function (result) {
                    logger.info("AddJournalVolumeToCopy for Prod RETURN: " + JSON.stringify(result));
            ...
            function (arg1, callback) {
                logger.info("--------  Create copy for Local ------")
                util.sleep(5000);
            ...
            function (arg1, callback) {
                logger.info("--------  AddJournalVolumeToCopy for Local ------")
                util.sleep(5000);
                ...
                AddJournalVolumeToCopy(rpainfo, paramater, function (result) {
                    logger.info("AddJournalVolumeToCopy for Local RETURN: " + JSON.stringify(result)); 
                    result.data =paramater;
                    if (result.code != 200) {
                        callback(result.code, result);
                    } else
            ...
            function (arg1, callback) {
                logger.info("--------  CreateCopy for Remote ------")
                util.sleep(5000);
            ...
            function (arg1, callback) {
                logger.info("--------  AddJournalVolumeToCopy for Remote ------")
                util.sleep(5000);
                ...
                AddJournalVolumeToCopy(rpainfo, paramater, function (result) {
                    logger.info("AddJournalVolumeToCopy for Remote RETURN: " + JSON.stringify(result));
                    result.data =paramater;
                    if (result.code != 200) {
                        callback(result.code, result);
                    } else
            ...
            function (arg1, callback) {
                logger.info("--------  CreateLink for Prod to Local ------")
                util.sleep(5000);
            ...
            function (arg1, callback) {
                logger.info("--------  CreateLink for Prod to Remote ------")
                util.sleep(5000);
...
function AddJournalVolumeToCopy(rpainfo, paramater, callback) {
    ...
    async.waterfall(
        [
            function (callback) {
                logger.info("    *** AddJournalVolumeToCopy  getcopys ***");
            ...
            function (copy, callback) {
                logger.info("    *** AddJournalVolumeToCopy  getvolumes ***");
                GetVolumes(rpainfo, clustername, function (volumes) {

                    for (var i in volumes) {
                        var item = volumes[i];
                        logger.info(item.volumeName);
                        var isfind = false;
            ...
            function (copy, callback) {
                logger.info("    *** AddJournalVolumeToCopy  call post for add  ***");
