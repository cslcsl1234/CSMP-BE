        ...
        [
            ...
            function (callback) {
                ...
                async.mapSeries(arrayinfos, function (arrayinfoItem, subcallback) {
                    logger.info(`Begin SyncDeviceID for array ${JSON.stringify(arrayinfoItem)}.`);
...
function GenerateVolNameV2(arrayinfo, appname, usedfor, timestamp) {
    if ((arrayinfo === undefined) || (appname === undefined) || (usedfor === undefined) || (timestamp === undefined))
        return null;
    var arraySN = arrayinfo.serial_no;
    var subArraySN = arraySN.substring(arraySN.length - 3, arraySN.length);
...
// Should be return MaskingView Name list
