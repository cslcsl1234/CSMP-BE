...
async function connect() {
    ...
    try {
        const zbc = new ZB.ZBClient(config.ZEEBE.BROKER, { loglevel: "ERROR" });
        return zbc;
    } catch (error) {
...
async function createProcessWorker() {
    ...
    zbc.createWorker({
        taskType: 'RPA-GetRPAConfiguration',
    ...
    zbc.createWorker({
        taskType: 'RPA-GetConsistencyGroups',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-MappingProdVolume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
     ...
     */
    zbc.createWorker({
        taskType: 'RPA-Local-InitPRAInformation',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Local-Pre-VPLEX-Provider-Service',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Local-Post-VPLEX-Provider-Service',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Remote-Pre-VPLEX-Provider-Service',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Remote-Post-VPLEX-Provider-Service',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-create-physical-volume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-rediscovery-physical-array',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-claim-physical-device',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-create-extent',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-create-device',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-create-virtual-volume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-assign-consistency-group',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-loacl-assign-storage-view',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
     ...
     */
    zbc.createWorker({
        taskType: 'RPA-Remote-InitPRAInformation',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-local-unity-create-physical-volume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-local-vmax-create-physical-volume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-remote-unity-create-physical-volume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'vplex-rpa-remote-vmax-create-physical-volume',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
     ...
     */
    zbc.createWorker({
        taskType: 'RPA-Configure-InitPRAInformation',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Configure-create-replicate-set',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Configure-create-jounery-volumes',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
    ...
    zbc.createWorker({
        taskType: 'RPA-Configure-create-consistency-group',
        maxJobsToActivate: 32,
        loglevel: 'NONE',
        timeout: Duration.seconds.of(301), // 30s timeout
        onConnectionError: () => zbWorker.log('Disconnected'),
