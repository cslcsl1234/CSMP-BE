    ...
    if (fields.length > 0) {
        ...
        async.mapSeries(
                ...
                unirest
                    ...
                    .end(function (response) {
                        ...
                        if (response.error) {
                            ...
                            console.log(
                                `Task(${TaskSerial}) finished: ${result.result.length}`
                            );
            ...
            function (err, result) {
                ...
                console.log("#FinalRecords=[" + resItem.result.length + "]");
                console.log(
                    " ============================================================================================ "
                );
...
function CallGetPerformance(paramater, callback) {
    ...
    async.waterfall(
                    ...
                    function (backendItem, subcallback) {
                        ...
                        switch (config.ProductType) {
                            ...
                            case "Dev":
                                ...
                                switch (period) {
                                    case 0:
                                        var a = d1.getTime() - 86400000 * 1; // the day of 7 days before
                                        break;
                                    case 3600:
                                        var a = d1.getTime() - 86400000 * 7; // the day of 7 days before
                                        break;
                                    case 86400:
                                        var a = d1.getTime() - 86400000 * 30; // the day of 7 days before
                                        break;
                                    default: 
                                            var a = d1.getTime() - 86400000 * 7; // the day of 7 days before
                                            break;
                        ...
                        unirest
                            ...
                            .end(function (response) {
                                if (response.error) {
                                    ...
                                    console.log(
                                        `Task(${TaskSerial}) finished: ${resultRecord.values.length}, execute time (s): ${(executeEndTime - executeBeginTime)/1000}`
                                    );
        ...
        function (err, result) {
            ...
            console.log(" CallGetPerformance - FinalResult=[" + result.length + "]" + ", total execute time (s):" + (totalEndTime - totalBeginTime)/1000 );
            console.log(
                " ============================================================================================ "
            );
...
function DoGet_singleField(fields, paramater, callback) {
    ...
    var keys = paramater.keys;
    if (
        typeof paramater.result === "undefined" &&
        typeof paramater.filter_name !== "undefined"
    ) {
        fields = keys + ",name";
