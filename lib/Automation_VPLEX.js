        ...
        [
            ...
            function (AutoObject, callback) {
                ...
                ChooseVirtualVolumes(AutoObject, function (result) {
                    if (result.resMsg.code != 200) {
                        result.resMsg.message.push("execute step [ ChooseVirtualVolumes ] is FAIL!");
                        maincallback(result);
                    } else
                        callback(null, result);
                })
            ...
            , function (AutoObject, callback) {
                ...
                if ( AutoObjectResult.resMsg.code != 200 ) {
                    AutoObjectResult.resMsg.message.push("execute step [ GenerateActionParamaters ] is FAIL!");
                    ...
                    async.mapSeries(executeParamaters, function (executeParamater, subcallback) {
                        ...
                        switch (executeParamater.method) {
                            ...
                            default:
                                ...
                                AutoObject.resMsg.message.push("action [ " + executeParamater.method + " ] has not defined!");
