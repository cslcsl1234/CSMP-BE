...
function GetArrays(device, callback) {
 ...
 function getVplexDisks(device,callback) {
        ...
        var param = {};
        param['filter_name'] = '(name=\'Capacity\'|name=\'OperationalStatus\'|name=\'Availability\')';
        param['keys'] = ['device','partsn'];
        param['fields'] = ['part','disktype','vdisk','array','dev','isused','view','vvol'];

        if (typeof device !== 'undefined') { 
            param['filter'] = 'device=\''+device+'\'&parttype==\'Extent\'&!vstatus==\'inactive\'&source==\'VPLEX-Collector\'';
        } else {
            param['filter'] = 'parttype==\'Extent\'&!vstatus==\'inactive\'&source==\'VPLEX-Collector\'';
        } 
