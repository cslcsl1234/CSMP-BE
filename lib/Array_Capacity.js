...
function GetArrayTotalCapacity(periodType, callback) {
    ...
    if (periodType !== undefined) {
        switch (periodType) {
            ...
            default:
                var period = 3600;
                var start = util.getConfStartTime();
    ...
    async.waterfall([
        ...
        function (callback) {
            ...
            param['keys'] = ['serialnb', 'sstype', 'arraytyp', 'device'];
            ...
            CallGet.CallGetPerformance(param, function (retcap) {
                ...
                for (var i in retcap) {
                    ...
                    item['serialnb'] = item1.serialnb;
                    item['sstype'] = item1.sstype;
                    item['arraytyp'] = item1.arraytyp;
                    item['device'] = item1.device;

                    for (var fieldname in item1.matricsStat) {
                        item[fieldname] = item1.matricsStat[fieldname].last;
                        //logger.info(fieldname + '=' + item[fieldname] + '\t' + item1.matricsStat[fieldname].last);
                    }
                    ...
                    outputItem1["arraytyp"] = item.arraytyp;
                ...
                finalResult["Total"] = outputItem === undefined ? {} : outputItem;
        ...
        function (result, callback) {
            ...
            CallGet.CallGetPerformance(param, function (retcap) {
                ...
                for (var i in retcap) {
                    ...
                    item['serialnb'] = item1.serialnb;
                    for (var fieldname in item1.matricsStat) {
                        item[fieldname] = item1.matricsStat[fieldname].max;
                    }
...
function CombineCapacity(capacity) {
    ...
    if ( arg1.RawCapacity !== undefined ) {
        ...
        RawCapacity["RawCapacityTB"] = 0;
        RawCapacity["ConfiguredRawCapacityTB"] = 0;
        RawCapacity["UnconfiguredRawCapacityTB"] = 0;
        RawCapacity["HotSpareCapacityTB"] = 0;
        RawCapacity["UnusableCapacityTB"] = 0;
    
        RawCapacity["RawCapacityGB"] = 0;
        RawCapacity["ConfiguredRawCapacityGB"] = {};
        RawCapacity["UnconfiguredRawCapacityGB"] = 0;
        RawCapacity["HotSpareCapacityGB"] = 0;
        RawCapacity["UnusableCapacityGB"] = 0;
    }
    ...
    if ( arg1.ConfiguredUsableCapacity === undefined ) {
        arg1.ConfiguredUsableCapacity = {};
        arg1.ConfiguredUsableCapacity.PoolFreeCapacity = 0;
        arg1.ConfiguredUsableCapacity.FreeCapacity = 0;
    }
            ...
            for (var i in arg1) {
                ...
                for (var j in matrics) {
                    ...
                    if (j == 0) {
                        ...
                        //logger.info(T2allocateCapacity+"\t"+T1allocateCapacity);
