            ...
            function(callback){ 
                ...
                CallGet.CallGet(param, function(param) {       
                    ...
                    for ( var i in param.result ) {
                        ...
                        item.RawCapacity = (item.RawCapacity === undefined ? 0 : item.RawCapacity );
                        item.UnconfiguredCapacity = (item.UnconfiguredCapacity === undefined ? 0 : item.UnconfiguredCapacity );
                        item.ConfiguredUsableCapacity = (item.ConfiguredUsableCapacity === undefined ? 0 : item.ConfiguredUsableCapacity );
                        item.HotSpareCapacity = (item.HotSpareCapacity === undefined ? 0 : item.HotSpareCapacity );
                        item.RAIDOverheadCapacity = (item.RAIDOverheadCapacity === undefined ? 0 : item.RAIDOverheadCapacity );
                        item.UnusableCapacity = (item.UnusableCapacity === undefined ? 0 : item.UnusableCapacity );
            ...
            function(result,  callback){  
                ...
                CallGet.CallGet(param, function(param) {
                    ...
                    for ( var i in param.result ) {
                        ...
                        item.UsedCapacity = (item.UsedCapacity === undefined ? 0 : item.UsedCapacity );
                        item.PoolFreeCapacity = (item.PoolFreeCapacity === undefined ? 0 : item.PoolFreeCapacity );
                        item.FreeCapacity = (item.FreeCapacity === undefined ? 0 : item.FreeCapacity );
