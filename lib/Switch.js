...
function GetSwitchPorts(device, callback) {
    ...
    async.waterfall([
        function(callback){ 
            ...
            param['keys'] = ['device','partwwn']; 
            param['fields'] = ['devicesn','partid','part','porttype','partwwn','ifname','portwwn','maxspeed','partstat','partphys','gbicstat','lswwn','ip','lsname','fabwwn','domainid'];
            //param['fields'] = ['partid','porttype','partwwn','ifname','portwwn','maxspeed','partstat','partphys','gbicstat','lswwn','ip','lsname','domainid'];
        ...
        function(callback){ 
                ...
                unirest.get(config.Backend.URL + config.SRM_RESTAPI.METRICS_PROPERTIES_VALUE)
                        ...
                        .end(function (response) {
                           ...
                           //var resultJson = JSON.parse(response.raw_body).values;
                            callback(null,response.raw_body);
                        });
                */
                CallGet.CallGet(param, function(param) { 
                    var result = param.result ; 
