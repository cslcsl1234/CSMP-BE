...
function GetSwitchPorts(device, callback) {
    ...
    async.waterfall([
        function(callback){ 
            ...
            if (typeof device !== 'undefined') {  
                //param['filter'] = config.SRM_RESTAPI.BASE_FILTER+'device=\''+device+'\'&parttype=\'Port\'&!iftype=\'Ethernet\'&!discrim=\'FCoE\'';
                param['filter'] = config.SRM_RESTAPI.BASE_FILTER+'device=\''+device+'\'&!vstatus==\'inactive\'&parttype=\'Port\'&!iftype=\'Ethernet\'&!discrim=\'FCoE\'';
            } else {
                param['filter'] = config.SRM_RESTAPI.BASE_FILTER+'!vstatus==\'inactive\'&parttype=\'Port\'&!iftype=\'Ethernet\'&!discrim=\'FCoE\'';
            }
