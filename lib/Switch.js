...
function GetSwitchPorts(device, callback) {
    ...
    if (typeof device !== 'undefined') {  
        param['filter'] = 'device=\''+device+'\'&!vstatus==\'inactive\'&parttype=\'Port\'&!iftype=\'Ethernet\'&!discrim=\'FCoE\'&collcfg=\'Brocade_FCSwitchPort\'';
    } else {
        param['filter'] = '!vstatus==\'inactive\'&parttype=\'Port\'&!iftype=\'Ethernet\'&!discrim=\'FCoE\'&collcfg=\'Brocade_FCSwitchPort\'';
    }
    ...
    param['fields'] = ['fabwwn','partid','part','porttype','partwwn','ifname','portwwn','maxspeed','partstat','partphys','gbicstat','lswwn'];
    ...
    async.waterfall([
        ...
        function(arg1,  callback){ 
            ...
            for ( var i in arg1 ) {
                var portItem = arg1[i];
                portItem["connectedToWWN"] = portItem.portwwn;
