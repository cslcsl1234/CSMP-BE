...
function GetMaskViews(device, callback) {
        ...
        async.waterfall([
            ...
            function(callback){ 
                ...
                param['fields'] = ['serialsn','part','initgrp','portgrp','dirnport','sgname'];
    ...
    async.waterfall([
        function ( callback) { 
            ...
            CallGet.CallGet(param, function(param) {  
                ...
                for ( var i in luns ) {
                    var lunItem = luns[i];
                    if ( lunResult[lunItem.device] === undefined )
                        lunResult[lunItem.device] = {};
                    
                    
                    lunResult[lunItem.device][lunItem.part] = lunItem;
        ...
        function ( luns, callback ) { 
            ...
            CallGet.CallGet(param, function(param) { 
                ...
                for ( var i in param.result ) {
                    ...
                    if ( luns[item.device] === undefined ) continue;
                    if ( luns[item.device][item.lunname] === undefined ) continue;
                    lunDetailItem = luns[item.device][item.lunname];
